  ...
  group('Result', () {
    ...
    test('could be Success', () {
      ...
      switch (r) {
        ...
        default: fail('Should be Success');
      }
    });
  });
  ...
  group('Ordering', () {
    test('works for integers', () {
      ...
      switch (a) {
        ...
        default: fail('Should be Greater');
      }
